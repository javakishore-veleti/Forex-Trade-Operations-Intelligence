  ...
  template: `
    <section aria-label="Trade search" class="trade-search">
      ...
      <form (ngSubmit)="search()" class="search-form" role="search" aria-label="Search for a trade by ID">
        ...
        <small id="tradeIdHint" class="hint">Enter your trade identifier to view its lifecycle status</small>
      </form>
    </section>
  `,
  styles: [`
    ...
    .btn-search {
      padding: 0.5rem 1.5rem; background: #1565c0; color: #fff;
