...
@Component({
  ...
  template: `
    <div class="app-shell">
      <header class="app-header" role="banner">
        <h1 class="app-title">Trader Desk</h1>
        <nav aria-label="Main navigation" class="main-nav">
          <a routerLink="/trades" routerLinkActive="active" [routerLinkActiveOptions]="{exact: true}"
             aria-label="Trade Status">Trades</a>
          <a routerLink="/positions" routerLinkActive="active" aria-label="Position Summary">Positions</a>
          <a routerLink="/books" routerLinkActive="active" aria-label="Trading Book">Books</a>
        </nav>
  ...
  styles: [`
    ...
    .app-header {
      background: #0d47a1; color: #fff; padding: 1rem 1.5rem;
