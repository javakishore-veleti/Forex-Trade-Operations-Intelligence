"""Webhook POST with retry logic for capacity-forecast-model."""
...
def post_shortfall_alert(payload: dict) -> bool:
    """
    POST capacity shortfall alert to the configured webhook URL.
